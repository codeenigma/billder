...
module.exports = {
  ...
  get_billing_data(linkedAccountId, withoutTaxes, callback) {
    var billing = require('aws-billing')(config.aws.accountId, config.aws.key, config.aws.secret, config.aws.bucket, config.aws.region, linkedAccountId, withoutTaxes);
