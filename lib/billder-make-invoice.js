 ...
 */
function make_invoice(month, config_file, account) {
  ...
  request(options)
    .then(function (response) {
      ...
      make_provider_invoice.make_invoice(month, config_file, account);
...
module.exports = {
   ...
   */
  make_invoices(month, config_file) {
    ...
    for (var account in accounts) {
      ...
      make_invoice(month, config_file, accounts[account]);
    }
  }
