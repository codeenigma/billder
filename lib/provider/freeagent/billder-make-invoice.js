...
module.exports = {
  ...
  make_invoice(month, account) {

    /*
     * Fetch billing data from AWS.
     */
    billing_data.get_billing_data(month, account.AWS, true, function(costs) {
      var invoice_items = [];
      var running_total = 0;
      var products = [];
      invoice_item = {
      ...
      setTimeout(create_invoice, ms, account, invoice);
 ...
 */
function create_invoice(account, invoice) {
